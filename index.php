...
<body>
    ...
    <a href="agregar.php" class="button">Nuevo Cliente</a><br><br> <!-- Enlace para agregar un nuevo cliente -->
    <table>
        <thead>
            <tr>
            ...
            <?php foreach ($clientes as $cliente): ?> <!-- Iteración sobre el arreglo de clientes -->
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="eliminar.php?ci=<?php echo $cliente['CI']; ?>" class="button red-button">Eliminar</a> <!-- Enlace para eliminar el cliente -->
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <br>
    <a href="consulta_clientes.php" class="button -button">Consultar clientes por Mes/Año</a> <!-- Enlace para consultar clientes por Mes/Año -->
    <a href="caratula.html" class="button red-button">Inicio</a> <!-- Enlace para ir a la página de inicio -->
    <a href="ganancias.php" class="button purple-button">Ganancias</a> <!-- Enlace para consultar las ganancias -->
    <a href="consulta_sexo.php" class="button -button">Consultar por Genero</a> <!-- Enlace para consultar clientes por género -->
